...
import {departments, subjects } from "../schema/schema.js";
    ...
    try{
        ...
        if (search) {
            filterConditions.push(
                or(
                    ilike(subjects.name, `%${String(search).replace(/[%_]/g, '\\$&')}%`),
        ...
        // Get the total count of subjects matching the filter conditions
